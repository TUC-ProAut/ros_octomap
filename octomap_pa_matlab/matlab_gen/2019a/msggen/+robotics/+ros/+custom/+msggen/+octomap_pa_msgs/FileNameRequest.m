classdef FileNameRequest < robotics.ros.Message
    %FileNameRequest MATLAB implementation of octomap_pa_msgs/FileNameRequest
    ...
    properties (Constant)
        MessageType = 'octomap_pa_msgs/FileNameRequest' % The ROS message type
    end
    ...
    methods
        function obj = FileNameRequest(msg)
            %FileNameRequest Construct the message object FileNameRequest
        ...
        function set.Filename(obj, filename)
            ...
            validateattributes(filename, {'char', 'string'}, {}, 'FileNameRequest', 'Filename');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.octomap_pa_msgs.FileNameRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.octomap_pa_msgs.FileNameRequest;
            obj.reload(strObj);
        end
    end
end
